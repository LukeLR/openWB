...
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x015A, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x015C, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x015E, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x0160, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x0162, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x0164, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
...
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x48, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
resp = client.read_input_registers(0x4a, 2, unit=unit_id)
print(struct.unpack('>f', struct.pack('>HH', *resp.registers)))
